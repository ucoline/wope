...
class BackgroundProcess
{
        ...
        switch ($this->getOS()) {
            ...
            default:
                throw new RuntimeException(sprintf(
                    'Could not execute command "%s" because operating system "%s" is not supported by BackgroundProcess.',
                    $this->command,
                    PHP_OS
                ));
        }
    ...
    {
        $this->checkSupportingOS('BackgroundProcess can only check if a process is running on *nix-based systems, such as Unix, Linux or Mac OS X. You are running "%s".');
    ...
    {
        $this->checkSupportingOS('BackgroundProcess can only stop a process on *nix-based systems, such as Unix, Linux or Mac OS X. You are running "%s".');
    ...
    {
        $this->checkSupportingOS('BackgroundProcess can only return the PID of a process on *nix-based systems, such as Unix, Linux or Mac OS X. You are running "%s".');
     ...
     *
     * @throws RuntimeException if the operating system is not supported by BackgroundProcess
     *
     * @codeCoverageIgnore
     */
